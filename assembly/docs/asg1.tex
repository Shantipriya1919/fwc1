...
4.connect the pin A of 7447 to D13 of Arduino and remaining pins B,C and D to GND.\\ 
5.connect the pins D2,D3,D4 to 0's and 1's.Change the pins simultaneously to verify the POS expression truth table.\\
