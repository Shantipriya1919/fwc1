...
\item connect the pin A of 7447 to D13 of Arduino and remaining pins B,C and D to GND.\\ 
\item connect the pins D2,D3,D4 to 0's and 1's.Change the pins simultaneously to verify the POS expression truth table.\\
\item Verify the miinimized POS expression operation in assembly using the following code and making pin connections according to fig 2,Table 2\\
\end{enumerate}
